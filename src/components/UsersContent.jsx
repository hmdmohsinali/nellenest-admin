  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-600">Manage your users, roles, and permissions</p>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <button className="px-3 py-2 text-sm font-medium text-slate-500 bg-white border border-slate-300 rounded-md hover:bg-slate-50">
            Previous
          </button>
